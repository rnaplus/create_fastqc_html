...
def createImageGridHTML(
    write_dir, dirlist, img_filename, html_filename, title, ncols, img_width
):
    ...
    with open(os.path.join(write_dir, html_filename), "w") as f_out:
        ...
        for path in dirlist:
            ...
            f_out.write(
                '\t\t\t<td><a href="{0}">{1}<img width={2} src="{3}" title="{4}"></a></td>\n'.format(
...
def main():
    ...
    parser.add_option(
        ...
        "--img-width",
        dest="img_width",
        help="width (in pixels) of each thumbnail image. Must be >= 50. DEFAULT is 350 px",
        default=350,
    )
    ...
    with open(fname, "w") as f:
        ...
        f.write(
            '\t<a href="compare_per_base_sequence_quality.html">Per base sequence quality</a><br>\n'
        )
        f.write(
            '\t<a href="compare_per_sequence_quality.html">Per sequence quality</a><br>\n'
        )
        f.write(
            '\t<a href="compare_sequence_content.html">Per base sequence content</a><br>\n'
        )
        f.write(
            '\t<a href="compare_per_base_gc_content.html">Per base GC content</a><br>\n'
        )
        f.write(
            '\t<a href="compare_per_sequence_gc_content.html">Per sequence GC content</a><br>\n'
        )
        f.write(
            '\t<a href="compare_per_base_n_content.html">Per base N content</a><br>\n'
        )
        f.write(
            '\t<a href="compare_sequence_length_distribution.html">Sequence length distribution</a><br>\n'
        )
        f.write(
            '\t<a href="compare_sequence_duplication_levels.html">Sequence duplication levels</a><br>\n'
        )
        f.write(
            '\t<a href="compare_overrepresented_seqs.html">Overrepresented sequences</a><br>\n'
        )
        ...
        for path in dirlist:
            ...
            f.write(
                '\t{0}.&nbsp&nbsp&nbsp&nbsp<a href="{1}">{2}</a><br>\n'.format(
                    count, fastqc_report_path, fastqc_report_path
                )
            )
            count += 1
